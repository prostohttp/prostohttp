...
- ⚙️ Сейчас работаю с:  `JavaScript`, `TypeScript`, `Vue.js`, `Nuxt`,  `PHP`, `Laravel`, `Livewire`, `InertiaJS`, `Filament`, `AlpineJS`, `Node.js`, `Express`, `NestJS`, `REST`, `GraphQL`, `Html`,`Css`, `Tailwind`, `GitHub 😀`, `Figma`
- ⛮ Немного: `react`
